...
class PerformanceTester:
    ...
    def test_model_loading(self) -> Dict[str, Any]:
        ...
        synthesizer_result = self.time_function(
            Synthesizer, models_dir / "default" / "synthesizer.pt"
        )
    ...
    def test_inference_performance(self, num_samples: int = 5) -> Dict[str, Any]:
        ...
        for i in range(num_samples):
            ...
            # Test encoding
            embed_result = self.time_function(encoder.embed_utterance, dummy_audio)
            ...
            synthesis_result = self.time_function(
                synthesizer.synthesize_spectrograms, [dummy_text], [embed_result["result"]]
            )
